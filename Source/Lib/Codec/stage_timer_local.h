...
#define DEFINE_STAGE_TIMER(label, inner_fn, wrapper_fn)                       \
    static stage_acc64  g_##label##_cycles;                                   \
    static stage_flag32 g_##label##_registered;                               \
    static void         label##_stage_report(void) {                          \
        uint64_t pc = stage_process_ticks();                                  \
        fprintf(stderr,                                                       \
